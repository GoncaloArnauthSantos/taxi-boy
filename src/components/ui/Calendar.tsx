  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "absolute inset-x-0 top-0 flex w-full items-center justify-between px-1 mb-3",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "h-8 w-8 select-none p-0 rounded-md hover:bg-accent hover:text-accent-foreground transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer aria-disabled:opacity-30 aria-disabled:cursor-not-allowed aria-disabled:hover:scale-100",
        ...
        month_caption: cn(
          "flex h-[--cell-size] w-full items-center justify-center px-8 mb-3",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        // Text styling
        "[&>span]:text-sm [&>span]:font-medium [&>span]:opacity-100",
        defaultClassNames.day,
        className
      )}
      {...props}
